...
silent only
cd C:\XAMPP\xampp\htdocs\js\iEhWriter
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 D:/Dropbox/My\ Dropbox/Text\ Files/PlacesToGoinCanada.txt
badd +0 script.js
args D:/Dropbox/My\ Dropbox/Text\ Files/PlacesToGoinCanada.txt
edit script.js
...
33
normal zo
let s:l = 48 - ((20 * winheight(0) + 19) / 39)
